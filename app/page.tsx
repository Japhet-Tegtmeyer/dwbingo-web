...
const Home: React.FC = () => {
  return (
    ...
    />
        ...
        <a href="https://apps.apple.com/us/app/dwbingo/id6472356354"><h4 className='flex justify-center p-3 ml-16 mr-16 rounded-full bg-blue-600 m-7 mt-10'>Download Alpha</h4></a>
